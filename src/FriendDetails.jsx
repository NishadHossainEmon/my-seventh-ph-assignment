...
const FriendDetails = () => {
  ...
  const { handleIsExistFriend } = ContextFriend;
  const expectedFriend = friends.find((friend) => id == friend.id);
          ...
          <div className="md:row-start-2 md:col-start-2 md:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <button
                ...
                className="flex flex-col bg-gray-100 items-center justify-center gap-2 py-3 rounded-xl hover:bg-gray-300 transition-all border border-gray-100 active:scale-95"
              >
              ...
              <button
                ...
                className="flex flex-col items-center justify-center bg-gray-100 gap-2 py-3 rounded-xl hover:bg-gray-300 transition-all border border-gray-100 active:scale-95"
              >
              ...
              <button
                ...
                className="flex flex-col items-center justify-center gap-2 py-3 bg-gray-100 rounded-xl hover:bg-gray-300 transition-all border border-gray-100 active:scale-95"
              >
