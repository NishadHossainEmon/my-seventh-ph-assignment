  ...
  return (
    <div className="md:pt-10 pb-7">
      <div className="text-center">
        ...
        <h1 className="text-3xl pt-3 sm:text-4xl font-bold text-gray-900 mb-3">
          Friends to keep close in your life
        </h1>
        <p className="text-base text-gray-500 max-w-lg sm:max-w-xl mx-auto leading-relaxed mb-6">
          Your personal shelf of meaningful connections. Browse, tend, and
          nurture the <br></br> relationships that matter most.
        </p>

        <button className="inline-flex items-center gap-1.5 bg-[#244d3f] hover:bg-[#162e25] text-white text-base font-medium px-5 py-2.5 rounded-md transition-colors">
