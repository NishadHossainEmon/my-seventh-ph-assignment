    ...
    <footer className="bg-[#1e3a2f] text-white">
      <div className="w-[80%] mx-auto">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-10 sm:py-12 flex flex-col items-center text-center">
          ...
          {/* Subtitle */}
          <p className="text-xs sm:text-sm text-gray-300 max-w-s sm:max-w-2xl mb-8 leading-relaxed">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full flex items-center justify-center transition-all">
              <AiFillInstagram className="text-black text-base sm:text-lg" />
            </a>

            <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full flex items-center justify-center transition-all">
              <FaSquareFacebook className="text-black text-base sm:text-lg" />
            </a>

            <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full flex items-center justify-center transition-all">
              <FaXTwitter className="text-black text-base sm:text-lg" />
            </a>
        ...
        <div className="border-t border-gray-100 border-opacity-20">
          <div className="container mx-auto py-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-400">
